...
| [Transactional](/components/modal/usage#transactional-modal)   | Requires an action to be taken in order for the modal to be completed and closed. Contains cancel and primary action buttons. |
...
| [Progress](/components/modal/usage#progress-modal)             | Requires several steps to be completed before it can be closed. Contains cancel, previous, and next/completion buttons.       |
